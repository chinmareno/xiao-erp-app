-- CreateEnum
CREATE TYPE "PurchaseOrderStatus" AS ENUM ('UNRECEIVED', 'RECEIVED');
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
